...
These values will pop up. Once again **MAKE SURE TO SAVE THESE** as you will not be shown them again. Once you have these saved, we can go back to QGIS. 
...
In conclusion this tutorial aimed to introduce you to open data, specifically crowdsourced and social media data. We acquired data using direct download, API query through a graphical user interface on the web, and API query through a QGIS plugin. We then mapped these data, and with a simple example demonstrated how you might draw conclusions from them all together. I hope this has been a fun exercise, and if you have any questions, don't hesitate to keep in touch and ask!
